...
"""No se toman en cuenta los datos tipo objecto"""

df = df.select_dtypes(exclude=['object'])

"""Aca se verifica si faltan algunos datos."""

print('Datos faltantes: ')
print(pd.isnull(df).sum())

"""Se realiza una descripción estadistica de la tabla donde se muestra datos como el maximo, el 75%, 50%, la minima, media, 25% y demás datos."""
...
"""Aplicación de algoritmos de Marching Learning
...
"""Se separan las variables independientes"""

X = df.iloc[:, :-1].values
y = df.iloc[:, -1].values

"""Se separan los datos de "train" en entremaniento y prueba para probar los algoritmos"""
...
acc_logreg = logreg.predict(X_test)
print("Precision Regresion Logistica")
print(logreg.score(X_train, y_train))

"""Super Vector Maching"""

svc = SVC()
svc.fit(X_train, y_train)
acc_svc = svc.predict(X_test)
...
acc_gnb = nb.predict(X_test)
print("Precisión Naive Bayes")
